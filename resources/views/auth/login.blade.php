                ...
                <div class="row flex-grow">
                    <div class="col-xl-6 mx-auto">
                        ...
                        <div class="auth-form-light rounded-lg text-left p-5">
                            ...
                            <div class="brand-logo text-center">
    <img src="{{ asset('images/spark_learnings_logo.jpg') }}" alt="Spark Learnings" style="width: 200px; height: auto;">
    <h1 style="font-size: 24px; color: #333; margin-top: 10px;">Spark Learnings</h1>
</div>
                            ...
                            <form action="{{ route('login') }}" id="frmLogin" method="POST" class="pt-3">
                                ...
                                @if (Route::has('password.request'))
                                    <div class="my-2 d-flex justify-content-between align-items-center">
                                        <a class="auth-link text-black" href="{{ url('/') }}">
                                            {{ __('Home') }}
                                        </a>
