<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        ...
        <a class="navbar-brand brand-logo" href="{{ URL::to('/') }}">
    <img src="{{ asset('images/262329197_978933919401890_6443785250824527782_n-e1664174070657 (1).jpg') }}" alt="logo" data-custom-image="{{$systemSettings['horizontal_logo'] ?? asset('/assets/horizontal-logo2.svg')}}" class="custom-default-image">
</a>
<a class="navbar-brand brand-logo-mini" href="{{ URL::to('/') }}">
    <img src="{{ asset('images/262329197_978933919401890_6443785250824527782_n-e1664174070657 (1).jpg') }}" alt="logo" data-custom-image="{{$systemSettings['vertical_logo'] ?? asset('/assets/vertical-logo.svg')}}">
</a>
